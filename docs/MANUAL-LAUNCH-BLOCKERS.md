...
| 3 | **G-03** / **E-08** | Execute §13 smoke + **payment email matrix** (tip = thank-you only; paid create/upgrade = Stripe receipt; contact → `contact@3arida.org`). Optional `npm run test:e2e:smoke`. | Tracker §13–§14, [`PAYMENT-EMAIL-MATRIX.md`](./PAYMENT-EMAIL-MATRIX.md), [`STAGING-DRY-RUN.md`](./STAGING-DRY-RUN.md) |
