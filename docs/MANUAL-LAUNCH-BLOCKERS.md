...
| 3 | **G-03** / **E-08** | **Auth email/password + verification:** done on prod (§15 EV-01–EV-09). **Still run:** §13 petition create/sign smoke + **payment email matrix** (tip / paid create / upgrade). Optional `npm run test:e2e:smoke`. | Tracker §13–§15, [`FIREBASE-EMAIL-VERIFICATION.md`](./FIREBASE-EMAIL-VERIFICATION.md), [`PAYMENT-EMAIL-MATRIX.md`](./PAYMENT-EMAIL-MATRIX.md) |
