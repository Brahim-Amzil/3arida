...
| 3 | **G-03** / **E-08** | **E-08 done** (tips, upgrade, contact). **Still run:** §13 petition create/sign smoke; paid-create Stripe receipt after BETA100 ends. Optional `npm run test:e2e:smoke`. | Tracker §13–§15, [`PAYMENT-EMAIL-MATRIX.md`](./PAYMENT-EMAIL-MATRIX.md) |
