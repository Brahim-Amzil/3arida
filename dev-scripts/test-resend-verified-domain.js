...
async function testResendWithDomain() {
  try {
    ...
    console.log('Testing with verified domain 3arida.org...');
    
    const resend = new Resend(apiKey);
    
    // Test 1: Send from noreply@3arida.org to contact@3arida.org
    console.log('\nTest 1: noreply@3arida.org -> contact@3arida.org');
