...
async function diagnose() {
  ...
  console.log(`   RESEND_FROM_EMAIL: ${process.env.RESEND_FROM_EMAIL || 'noreply@3arida.org'}`);
  console.log(`   CONTACT_EMAIL: ${process.env.CONTACT_EMAIL || 'contact@3arida.org'}`);
  
  // 4. Send a test email with detailed tracking
  console.log('\n4. Sending test email...');
  const testResult = await resend.emails.send({
    from: '3arida Platform <noreply@3arida.org>',
    to: 'contact@3arida.org',
    ...
    html: `
      ...
      <ul>
        <li>From: noreply@3arida.org</li>
        <li>To: contact@3arida.org</li>
        <li>Domain: 3arida.org (verified)</li>
  ...
  console.log('\n=== DIAGNOSTIC COMPLETE ===');
  console.log('\nNext steps:');
  console.log('1. Check contact@3arida.org inbox (including spam folder)');
  console.log('2. Check Hostinger webmail: https://webmail.hostinger.com');
  console.log('3. Look for emails from noreply@3arida.org');
