"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{9978:function(e,t,n){n.d(t,{Bt:function(){return sK},EK:function(){return P},ET:function(){return sU},IO:function(){return sm},JU:function(){return iP},PL:function(){return sM},QT:function(){return sL},TQ:function(){return sI},Xo:function(){return sv},Yp:function(){return sz},ad:function(){return i$},ar:function(){return sg},b9:function(){return sE},cf:function(){return sq},hJ:function(){return iF},nP:function(){return sQ},oe:function(){return sP},pl:function(){return sO},r7:function(){return sF}});var r,i,s,a,o=n(206),l=n(5538),u=n(6914),h=n(8745),c=n(3172),d=n(4203);n(2601);var f=n(7133).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nP{constructor(){this.Tr=new es(nU.Er),this.dr=new es(nU.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){let n=new nU(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new nU(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){let t=new K(new B([])),n=new nU(t,e),r=new nU(t,e+1),i=[];return this.dr.forEachInRange([n,r],e=>{this.Vr(e),i.push(e.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){let t=new K(new B([])),n=new nU(t,e),r=new nU(t,e+1),i=tw();return this.dr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nU(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nU{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return K.comparator(e.key,t.key)||O(e.wr,t.wr)}static Ar(e,t){return O(e.wr,t.wr)||K.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sl{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new iM(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new su(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(sh("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class su extends sl{data(){return super.data()}}function sh(e,t){return"string"==typeof t?ss(e,t):t instanceof ij?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sL(e){e=iR(e,iM);let t=iR(e.firestore,iB);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iw({next:o=>{s.Za(),t.enqueueAndForget(()=>rQ(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rH(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rK(e,a)})(await iC(e),e.asyncQueue,t,n,r)),r.promise})(iz(t),e._key).then(n=>s$(t,e,n))}class sV extends sN{constructor(e){super(),this.firestore=e}convertBytes(e){return new iG(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iM(this.firestore,null,t)}}function sM(e){e=iR(e,iV);let t=iR(e.firestore,iB),n=iz(t),r=new sV(t);return sc(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iw({next:n=>{s.Za(),t.enqueueAndForget(()=>rQ(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rH(n,s,{includeMetadataChanges:!0,_a:!0});return rK(e,a)})(await iC(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sx(t,r,e,n))}function sO(e,t,n){e=iR(e,iM);let r=iR(e.firestore,iB),i=sb(e.converter,t,n);return sB(r,[i4(i3(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tM.none())])}function sF(e,t,n,...r){e=iR(e,iM);let i=iR(e.firestore,iB),s=i3(i);return sB(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof ij?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[sr(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(sr(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!so(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof i9)u.push(t);else{let e=i7(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iZ(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);sn("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=ss(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof i9)s.push(o);else{let e=i7(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iZ(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tM.exists(!0))])}function sP(e){return sB(iR(e.firestore,iB),[new tG(e._key,tM.none())])}function sU(e,t){let n=iR(e.firestore,iB),r=iP(e),i=sb(e.converter,t);return sB(n,[i4(i3(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tM.exists(!1))]).then(()=>r)}function sq(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iq(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iq(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iM)a=iR(e.firestore,iB),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](s$(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iR(e,iV);a=iR(n.firestore,iB),o=n._query;let r=new sV(a);s={next:e=>{t[u]&&t[u](new sx(a,r,n,e))},error:t[u+1],complete:t[u+2]},sc(e._query)}return function(e,t,n,r){let i=new iw(r),s=new rH(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rK(await iC(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rQ(await iC(e),s))}}(iz(a),o,c,s)}function sB(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r6(await iI(e).then(e=>e.syncEngine),t,n)),n.promise}(iz(e),t)}function s$(e,t,n){let r=n.docs.get(t._key),i=new sV(e);return new sD(e,i,t._key,r,new sk(n.hasPendingWrites,n.fromCache),t.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
