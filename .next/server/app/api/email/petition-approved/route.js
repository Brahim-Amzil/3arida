"use strict";(()=>{var e={};e.id=8359,e.ids=[8359],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},22358:(e,a,t)=>{t.r(a),t.d(a,{headerHooks:()=>g,originalPathname:()=>b,patchFetch:()=>f,requestAsyncStorage:()=>c,routeModule:()=>h,serverHooks:()=>v,staticGenerationAsyncStorage:()=>u,staticGenerationBailout:()=>m});var r={};t.r(r),t.d(r,{POST:()=>l});var i=t(95419),o=t(69108),n=t(99678),s=t(78070),d=t(59631),p=t(64348);async function l(e){try{let{userName:a,userEmail:t,petitionTitle:r,petitionId:i}=await e.json();if(!a||!t||!r||!i)return s.Z.json({error:"Missing required fields"},{status:400});let o=(0,p.Kh)(a,r,i,t);if((await (0,d.C)({to:t,subject:`✅ تمت الموافقة على عريضتك: ${r}`,html:o})).success)return s.Z.json({success:!0});return s.Z.json({error:"Failed to send email"},{status:500})}catch(e){return console.error("Petition approved email error:",e),s.Z.json({error:"Internal server error"},{status:500})}}let h=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/email/petition-approved/route",pathname:"/api/email/petition-approved",filename:"route",bundlePath:"app/api/email/petition-approved/route"},resolvedPagePath:"/Users/brahimamzil/Downloads/DEV_APPS/----3arida/3arida-app/src/app/api/email/petition-approved/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:c,staticGenerationAsyncStorage:u,serverHooks:v,headerHooks:g,staticGenerationBailout:m}=h,b="/api/email/petition-approved/route";function f(){return(0,n.patchFetch)({serverHooks:v,staticGenerationAsyncStorage:u})}},59631:(e,a,t)=>{t.d(a,{C:()=>i,q:()=>o});let r=new(t(75180)).R(process.env.RESEND_API_KEY);async function i({to:e,subject:a,html:t}){try{let i=await r.emails.send({from:process.env.EMAIL_FROM||"onboarding@resend.dev",to:e,subject:a,html:t});return console.log("Email sent successfully:",i),{success:!0,data:i}}catch(e){return console.error("Failed to send email:",e),{success:!1,error:e}}}function o(){return`
    <style>
  ...
  `}}};var a=require("../../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),r=a.X(0,[1638,6206,5180],()=>t(22358));module.exports=r})();