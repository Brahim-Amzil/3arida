"use strict";(()=>{var e={};e.id=3673,e.ids=[3673],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},35194:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>v,originalPathname:()=>f,patchFetch:()=>b,requestAsyncStorage:()=>h,routeModule:()=>c,serverHooks:()=>g,staticGenerationAsyncStorage:()=>u,staticGenerationBailout:()=>m});var a={};r.r(a),r.d(a,{POST:()=>p});var i=r(95419),o=r(69108),n=r(99678),s=r(78070),l=r(59631),d=r(64348);async function p(e){try{let{userName:t,userEmail:r,petitionTitle:a,petitionId:i}=await e.json();if(!t||!r||!a||!i)return s.Z.json({error:"Missing required fields"},{status:400});let o=(0,d.DN)(t,a,i,r);if((await (0,l.C)({to:r,subject:`✍️ شكرا على توقيعك: ${a}`,html:o})).success)return s.Z.json({success:!0});return s.Z.json({error:"Failed to send email"},{status:500})}catch(e){return console.error("Signature confirmation email error:",e),s.Z.json({error:"Internal server error"},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/email/signature-confirmation/route",pathname:"/api/email/signature-confirmation",filename:"route",bundlePath:"app/api/email/signature-confirmation/route"},resolvedPagePath:"/Users/brahimamzil/Downloads/DEV_APPS/----3arida/3arida-app/src/app/api/email/signature-confirmation/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:h,staticGenerationAsyncStorage:u,serverHooks:g,headerHooks:v,staticGenerationBailout:m}=c,f="/api/email/signature-confirmation/route";function b(){return(0,n.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:u})}},59631:(e,t,r)=>{r.d(t,{C:()=>o,q:()=>n});var a=r(75180);let i=null;async function o({to:e,subject:t,html:r}){let o=(!i&&process.env.RESEND_API_KEY&&(i=new a.R(process.env.RESEND_API_KEY)),i);if(!o)return console.warn("Resend API key not configured - email not sent"),{success:!1,error:"Email service not configured"};try{let a=await o.emails.send({from:process.env.EMAIL_FROM||"onboarding@resend.dev",to:e,subject:t,html:r});return console.log("Email sent successfully:",a),{success:!0,data:a}}catch(e){return console.error("Failed to send email:",e),{success:!1,error:e}}}function n(){return`
  ...
  `}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[1638,6206,5180],()=>r(35194));module.exports=a})();