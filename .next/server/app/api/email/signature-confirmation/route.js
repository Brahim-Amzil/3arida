"use strict";(()=>{var e={};e.id=3673,e.ids=[3673],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},35194:(e,a,t)=>{t.r(a),t.d(a,{headerHooks:()=>m,originalPathname:()=>f,patchFetch:()=>b,requestAsyncStorage:()=>h,routeModule:()=>c,serverHooks:()=>g,staticGenerationAsyncStorage:()=>u,staticGenerationBailout:()=>v});var r={};t.r(r),t.d(r,{POST:()=>p});var i=t(95419),o=t(69108),n=t(99678),s=t(78070),d=t(59631),l=t(64348);async function p(e){try{let{userName:a,userEmail:t,petitionTitle:r,petitionId:i}=await e.json();if(!a||!t||!r||!i)return s.Z.json({error:"Missing required fields"},{status:400});let o=(0,l.DN)(a,r,i,t);if((await (0,d.C)({to:t,subject:`✍️ شكرا على توقيعك: ${r}`,html:o})).success)return s.Z.json({success:!0});return s.Z.json({error:"Failed to send email"},{status:500})}catch(e){return console.error("Signature confirmation email error:",e),s.Z.json({error:"Internal server error"},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/email/signature-confirmation/route",pathname:"/api/email/signature-confirmation",filename:"route",bundlePath:"app/api/email/signature-confirmation/route"},resolvedPagePath:"/Users/brahimamzil/Downloads/DEV_APPS/----3arida/3arida-app/src/app/api/email/signature-confirmation/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:h,staticGenerationAsyncStorage:u,serverHooks:g,headerHooks:m,staticGenerationBailout:v}=c,f="/api/email/signature-confirmation/route";function b(){return(0,n.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:u})}},59631:(e,a,t)=>{t.d(a,{C:()=>i,q:()=>o});let r=new(t(75180)).R(process.env.RESEND_API_KEY);async function i({to:e,subject:a,html:t}){try{let i=await r.emails.send({from:process.env.EMAIL_FROM||"onboarding@resend.dev",to:e,subject:a,html:t});return console.log("Email sent successfully:",i),{success:!0,data:i}}catch(e){return console.error("Failed to send email:",e),{success:!1,error:e}}}function o(){return`
    <style>
  ...
  `}},64348:(e,a,t)=>{t.d(a,{DN:()=>n,FG:()=>i,Kh:()=>o,Qn:()=>s,rs:()=>d});var r=t(59631);function i(e,a){return`
    <!DOCTYPE html>
    <html>
      <head>
        ${(0,r.q)()}
  ...
  `}function d(e,a,t,i,o,n,s){return`
    <!DOCTYPE html>
    <html>
      <head>
        ${(0,r.q)()}
  ...
  `}}};var a=require("../../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),r=a.X(0,[1638,6206,5180],()=>t(35194));module.exports=r})();