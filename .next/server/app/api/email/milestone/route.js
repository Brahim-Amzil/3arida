"use strict";(()=>{var e={};e.id=983,e.ids=[983],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},25570:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>g,originalPathname:()=>f,patchFetch:()=>b,requestAsyncStorage:()=>h,routeModule:()=>c,serverHooks:()=>v,staticGenerationAsyncStorage:()=>u,staticGenerationBailout:()=>m});var a={};r.r(a),r.d(a,{POST:()=>p});var i=r(10884),o=r(16132),s=r(21040),n=r(95798),l=r(61513),d=r(87640);async function p(e){try{let{userName:t,userEmail:r,petitionTitle:a,petitionId:i,milestone:o,currentSignatures:s,targetSignatures:p}=await e.json();if(!t||!r||!a||!i||!o||!s||!p)return n.Z.json({error:"Missing required fields"},{status:400});let c=(0,d.rs)(t,a,i,o,s,p,r);if((await (0,l.C)({to:r,subject:`🎯 عريضتك وصلت إلى ${o}%: ${a}`,html:c})).success)return n.Z.json({success:!0});return n.Z.json({error:"Failed to send email"},{status:500})}catch(e){return console.error("Milestone email error:",e),n.Z.json({error:"Internal server error"},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/email/milestone/route",pathname:"/api/email/milestone",filename:"route",bundlePath:"app/api/email/milestone/route"},resolvedPagePath:"/Users/brahimamzil/Downloads/DEV_APPS/----3arida/3arida-app/src/app/api/email/milestone/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:h,staticGenerationAsyncStorage:u,serverHooks:v,headerHooks:g,staticGenerationBailout:m}=c,f="/api/email/milestone/route";function b(){return(0,s.patchFetch)({serverHooks:v,staticGenerationAsyncStorage:u})}},61513:(e,t,r)=>{r.d(t,{C:()=>o,q:()=>s});var a=r(86935);let i=null;async function o({to:e,subject:t,html:r}){let o=(!i&&process.env.RESEND_API_KEY&&(i=new a.R(process.env.RESEND_API_KEY)),i);if(!o)return console.warn("Resend API key not configured - email not sent"),{success:!1,error:"Email service not configured"};try{let a=await o.emails.send({from:process.env.EMAIL_FROM||"onboarding@resend.dev",to:e,subject:t,html:r});return console.log("Email sent successfully:",a),{success:!0,data:a}}catch(e){return console.error("Failed to send email:",e),{success:!1,error:e}}}function s(){return`
    <style>
  ...
  `}},87640:(e,t,r)=>{r.d(t,{DN:()=>s,FG:()=>i,Kh:()=>o,Qn:()=>n,rs:()=>l});var a=r(61513);function i(e,t){return`
    <!DOCTYPE html>
    <html>
      <head>
        ${(0,a.q)()}
  ...
  `}function l(e,t,r,i,o,s,n){return`
    <!DOCTYPE html>
    <html>
      <head>
        ${(0,a.q)()}
  ...
  `}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[3271,8107,6935],()=>r(25570));module.exports=a})();