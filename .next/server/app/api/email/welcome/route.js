"use strict";(()=>{var e={};e.id=6271,e.ids=[6271],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},5975:(e,a,t)=>{t.r(a),t.d(a,{headerHooks:()=>g,originalPathname:()=>b,patchFetch:()=>f,requestAsyncStorage:()=>h,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>u,staticGenerationBailout:()=>v});var r={};t.r(r),t.d(r,{POST:()=>p});var i=t(95419),o=t(69108),s=t(99678),n=t(78070),d=t(59631),l=t(64348);async function p(e){try{let{userName:a,userEmail:t}=await e.json();if(!a||!t)return n.Z.json({error:"Missing required fields"},{status:400});let r=(0,l.FG)(a,t);if((await (0,d.C)({to:t,subject:"مرحبا بك في 3arida - Welcome to 3arida",html:r})).success)return n.Z.json({success:!0});return n.Z.json({error:"Failed to send email"},{status:500})}catch(e){return console.error("Welcome email error:",e),n.Z.json({error:"Internal server error"},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/email/welcome/route",pathname:"/api/email/welcome",filename:"route",bundlePath:"app/api/email/welcome/route"},resolvedPagePath:"/Users/brahimamzil/Downloads/DEV_APPS/----3arida/3arida-app/src/app/api/email/welcome/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:h,staticGenerationAsyncStorage:u,serverHooks:m,headerHooks:g,staticGenerationBailout:v}=c,b="/api/email/welcome/route";function f(){return(0,s.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:u})}},59631:(e,a,t)=>{t.d(a,{C:()=>i,q:()=>o});let r=new(t(75180)).R(process.env.RESEND_API_KEY);async function i({to:e,subject:a,html:t}){try{let i=await r.emails.send({from:process.env.EMAIL_FROM||"onboarding@resend.dev",to:e,subject:a,html:t});return console.log("Email sent successfully:",i),{success:!0,data:i}}catch(e){return console.error("Failed to send email:",e),{success:!1,error:e}}}function o(){return`
    <style>
  ...
  `}}};var a=require("../../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),r=a.X(0,[1638,6206,5180],()=>t(5975));module.exports=r})();