"use strict";exports.id=3754,exports.ids=[3754],exports.modules={23754:(e,t,a)=>{let i,n,r,o;a.d(t,{getAnalytics:()=>eT,logEvent:()=>eS});var s=a(3393),l=a(47339),c=a(24845),u=a(96587),d=a(53449);let f="@firebase/installations",p="0.6.9",h=`w:${p}`,g="FIS_v2",m=new c.LL("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function w(e){return e instanceof c.ZR&&e.code.includes("request-failed")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let j=new Map;function A(e,t){let a=$(e);D(a,t),function(e,t){let a=(!q&&"BroadcastChannel"in self&&((q=new BroadcastChannel("[Firebase] FID Change")).onmessage=e=>{D(e.data.key,e.data.fid)}),q);a&&a.postMessage({key:e,fid:t}),0===j.size&&q&&(q.close(),q=null)}(a,t)}function D(e,t){let a=j.get(e);if(a)for(let e of a)e(t)}let q=null,F="firebase-installations-store",M=null;function x(){return M||(M=(0,d.X3)("firebase-installations-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(F)}})),M}async function P(e,t){let a=$(e),i=(await x()).transaction(F,"readwrite"),n=i.objectStore(F),r=await n.get(a);return await n.put(t,a),await i.done,r&&r.fid===t.fid||A(e,t.fid),t}async function O(e){let t=$(e),a=(await x()).transaction(F,"readwrite");await a.objectStore(F).delete(t),await a.done}async function z(e,t){let a=$(e),i=(await x()).transaction(F,"readwrite"),n=i.objectStore(F),r=await n.get(a),o=t(r);return void 0===o?await n.delete(a):await n.put(o,a),await i.done,o&&(!r||r.fid!==o.fid)&&A(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function E(e){let t;let a=await z(e.appConfig,a=>{let i=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine)return{installationEntry:t,registrationPromise:Promise.reject(m.create("app-offline"))};let a={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=L(e,a);return{installationEntry:a,registrationPromise:i}}return 1===t.registrationStatus?{installationEntry:t,registrationPromise:N(e)}:{installationEntry:t}}(e,R(a||{fid:function(){try{let e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;let t=btoa(String.fromCharCode(...e)).replace(/\+/g,"-").replace(/\//g,"_").substr(0,22);return C.test(t)?t:""}catch(e){return""}}(),registrationStatus:0}));return t=i.registrationPromise,i.installationEntry});return""===a.fid?{installationEntry:await t}:{installationEntry:a,registrationPromise:t}}async function L(e,t){try{let a=await S(e,t);return P(e.appConfig,a)}catch(a){throw w(a)&&409===a.customData.serverCode?await O(e.appConfig):await P(e.appConfig,{fid:t.fid,registrationStatus:0}),a}}async function N(e){let t=await K(e.appConfig);for(;1===t.registrationStatus;)await k(100),t=await K(e.appConfig);if(0===t.registrationStatus){let{installationEntry:t,registrationPromise:a}=await E(e);return a||t}return t}function K(e){return z(e,e=>{if(!e)throw m.create("installation-not-found");return R(e)})}function R(e){return 1===e.registrationStatus&&e.registrationTime+1e4<Date.now()?{fid:e.fid,registrationStatus:0}:e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function X({appConfig:e,heartbeatServiceProvider:t},a){let i=function(e,{fid:t}){return`${y(e)}/${t}/authTokens:generate`}(e,a),n=function(e,{refreshToken:t}){let a=I(e);return a.append("Authorization",`${g} ${t}`),a}(e,a),r=t.getImmediate({optional:!0});if(r){let e=await r.getHeartbeatsHeader();e&&n.append("x-firebase-client",e)}let o={method:"POST",headers:n,body:JSON.stringify({installation:{sdkVersion:h,appId:e.appId}})},s=await T(()=>fetch(i,o));if(s.ok)return v(await s.json());throw await b("Generate Auth Token",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _(e,t=!1){let a;let i=await z(e.appConfig,i=>{var n;if(!V(i))throw m.create("not-registered");let r=i.authToken;if(!t&&2===(n=r).requestStatus&&!function(e){let t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+36e5}(n))return i;if(1===r.requestStatus)return a=U(e,t),i;{if(!navigator.onLine)throw m.create("app-offline");let t=function(e){let t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}(i);return a=H(e,t),t}});return a?await a:i.authToken}async function U(e,t){let a=await B(e.appConfig);for(;1===a.authToken.requestStatus;)await k(100),a=await B(e.appConfig);let i=a.authToken;return 0===i.requestStatus?_(e,t):i}function B(e){return z(e,e=>{var t;if(!V(e))throw m.create("not-registered");return 1===(t=e.authToken).requestStatus&&t.requestTime+1e4<Date.now()?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function H(e,t){try{let a=await X(e,t),i=Object.assign(Object.assign({},t),{authToken:a});return await P(e.appConfig,i),a}catch(a){if(w(a)&&(401===a.customData.serverCode||404===a.customData.serverCode))await O(e.appConfig);else{let a=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await P(e.appConfig,a)}throw a}}function V(e){return void 0!==e&&2===e.registrationStatus}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G(e){let{installationEntry:t,registrationPromise:a}=await E(e);return a?a.catch(console.error):_(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function W(e,t=!1){return await Z(e),(await _(e,t)).token}async function Z(e){let{registrationPromise:t}=await E(e);t&&await t}function J(e){return m.create("missing-app-config-values",{valueName:e})}/**
 * @license
