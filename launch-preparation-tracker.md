...
| RPT-06 | Stripe one-off payment for extra report download (10 / 19 MAD) | P0 | Done | Stripe PaymentIntent + progress UX on prod (`1d1ff90`, `0d6fd0c`, `798d428`) |
...
| RPT-09 | Manual smoke: quotas + modal + verify page | P0 | Done | Prod smoke 2026-06-04: free 4→19 MAD, upgrade 69 MAD, paid 10 MAD, verify, refresh |
