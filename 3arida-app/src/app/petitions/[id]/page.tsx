                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-800 leading-relaxed">
                      This petition is protected against bots and spam with
                      invisible security verification powered by Google
                      reCAPTCHA v3. Every signature is automatically verified to
                      ensure authenticity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-green-800 leading-relaxed">
                      Petition creators must verify their phone number to ensure
                      accountability and prevent abuse. This helps maintain the
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-purple-800 leading-relaxed">
                      Every signature on this petition is verified and
                      authenticated. We prevent duplicate signatures and ensure
                      each supporter is a real person.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Your personal information is protected and will only be
                      used for petition-related purposes. We comply with data
                      protection regulations and never sell your data.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full min-w-0 space-y-6">
            ...
            >
              <CardContent className="p-6" style={{ width: '100%' }}>
                ...
                {/* 6. Action Buttons - Right below progress bar */}
                <div className="mb-6 w-full space-y-3">
                  {/* Sign Petition Button with Security Icon */}
                  <div className="flex gap-2 w-full">
                    ...
                    <button
                      ...
                      className="flex-shrink-0 w-12 h-12 flex items-center justify-center border-2 border-blue-300 bg-blue-50 rounded-md hover:bg-blue-100 transition-colors"
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-800">
                  This petition uses Google reCAPTCHA v3 to protect against
                  automated bots and spam signatures.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Security checks happen automatically without interrupting
                      your experience
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Each signature requires phone number verification to
                      prevent duplicates
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      All signatures on this platform are verified and authentic
                    </p>
                  </div>
                </div>
              </div>
