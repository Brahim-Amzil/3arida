...
const translations: Record<Locale, TranslationMessages> = {
  ar: {
    ...
    'auth.forgotPassword.cardTitle': 'نسيت كلمة المرور؟',
    'auth.forgotPassword.sendLink': 'إرسال رابط إعادة التعيين',
    'auth.forgotPassword.sending': 'جاري الإرسال...',
    'auth.forgotPassword.checkEmail': 'تحقق من بريدك',
    'auth.forgotPassword.sentTo': 'أرسلنا رابط إعادة التعيين إلى',
    'auth.forgotPassword.backToLogin': 'العودة لتسجيل الدخول',
    'auth.forgotPassword.rememberPassword': 'تتذكر كلمة المرور؟',
    'auth.forgotPassword.signIn': 'تسجيل الدخول',
    'auth.forgotPassword.noEmail': 'لم تصلك الرسالة؟',
    'auth.forgotPassword.checkSpam': 'تحقق من مجلد الرسائل غير المرغوب فيها',
    'auth.forgotPassword.verifyEmail': 'تأكد من صحة البريد الإلكتروني',
    'auth.forgotPassword.wait': 'انتظر بضع دقائق ثم أعد المحاولة',
    ...
    'auth.resetPassword.submit': 'حفظ كلمة المرور',
    'auth.resetPassword.saving': 'جاري الحفظ...',
    'auth.resetPassword.successTitle': 'تم تغيير كلمة المرور',
    'auth.resetPassword.successMessage':
      'يمكنك الآن تسجيل الدخول بكلمة المرور الجديدة',
    'auth.resetPassword.goToLogin': 'تسجيل الدخول',
    'auth.resetPassword.mismatch': 'كلمتا المرور غير متطابقتين',
    'auth.resetPassword.minLength': 'كلمة المرور يجب أن تكون 6 أحرف على الأقل',
    ...
    'updates.loadMore': 'تحميل المزيد من التحديثات',
    'updates.loadingMore': 'جاري التحميل...',
    ...
    'footer.supportPlatform': 'ساهم في دعم المنصة',
    ...
    'create.locationTargeting': 'التوقيعات المُستهدفة',
    ...
    'review.locationTargeting': 'التوقيعات المُستهدفة',
    ...
    'review.location': 'التوقيعات المستهدفة:',
  ...
  fr: {
    ...
    'auth.forgotPassword.cardTitle': 'Mot de passe oublié ?',
    'auth.forgotPassword.sendLink': 'Envoyer le lien',
    'auth.forgotPassword.sending': 'Envoi en cours...',
    'auth.forgotPassword.checkEmail': 'Vérifiez votre e-mail',
    'auth.forgotPassword.sentTo': 'Nous avons envoyé un lien à',
    'auth.forgotPassword.backToLogin': 'Retour à la connexion',
    'auth.forgotPassword.rememberPassword': 'Vous vous souvenez ?',
    'auth.forgotPassword.signIn': 'Se connecter',
    'auth.forgotPassword.noEmail': "Vous n'avez pas reçu l'e-mail ?",
    'auth.forgotPassword.checkSpam': 'Vérifiez les spams',
    'auth.forgotPassword.verifyEmail': "Vérifiez l'adresse e-mail",
    'auth.forgotPassword.wait': 'Attendez quelques minutes puis réessayez',
    ...
    'auth.resetPassword.submit': 'Enregistrer',
    'auth.resetPassword.saving': 'Enregistrement...',
    'auth.resetPassword.successTitle': 'Mot de passe modifié',
    'auth.resetPassword.successMessage':
      'Vous pouvez maintenant vous connecter avec votre nouveau mot de passe',
    'auth.resetPassword.goToLogin': 'Se connecter',
    ...
    'updates.loadMore': 'Charger plus de mises à jour',
    'updates.loadingMore': 'Chargement...',
    ...
    'footer.supportPlatform': 'Soutenir la plateforme',
