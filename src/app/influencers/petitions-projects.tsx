  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Beta Founder Banner */}
        <div className="mb-12 p-6 bg-gradient-to-r from-purple-50 via-blue-50 to-green-50 border-2 border-purple-300 rounded-xl text-center shadow-lg">
          <div className="flex items-center justify-center gap-3 mb-3">
            <span className="text-4xl">🎉</span>
            <h2 className="text-3xl font-bold text-purple-900">
              إطلاق تجريبي - جميع الميزات مجانية!
            </h2>
            <span className="text-4xl">🎉</span>
          </div>
          <p className="text-xl text-purple-800 mb-2 font-semibold">
            برنامج المؤثرين مجاني 100% خلال فترة الإطلاق التجريبي
          </p>
          <p className="text-lg text-purple-700">
            أنشئ عريضتك الآن واحصل على جميع الميزات المتقدمة مجاناً - لا حاجة
            لكوبونات!
          </p>
        </div>
