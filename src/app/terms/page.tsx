    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">شروط الخدمة</h1>
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <p className="mb-4">
                مرحبًا بك في منصة 3arida ("المنصة" أو "الخدمة"). من خلال الوصول
                إلى هذه المنصة أو استخدامها، فإنك توافق على الالتزام بشروط
                الخدمة هذه. يرجى قراءتها بعناية قبل استخدام خدماتنا.
              </p>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4">
                ...
                <li>
                  <strong>"العريضة"</strong> تشير إلى أي حملة أو طلب يتم إنشاؤه
                  على المنصة
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4">
                ...
                <li>غير محظور من استخدام الخدمة بموجب القوانين المعمول بها</li>
              </ul>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mb-2">
                    ...
                    ومجاني لاستخدام وعرض وتوزيع المحتوى الخاص بك على المنصة. أنت
                    تحتفظ بجميع حقوق الملكية في المحتوى الخاص بك.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 mr-4">
                  ...
                  <li>
                    قد يتم استخدام معلومات الاتصال الخاصة بك من قبل منشئ العريضة
                    للتحديثات (وفقًا لسياسة الخصوصية)
                  </li>
                  <li>
                    لا يمكن سحب التوقيعات بمجرد إرسالها (إلا في حالات استثنائية)
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <p>
                نحن ملتزمون بحماية خصوصيتك وأمان بياناتك وفقًا للقوانين المعمول
                بها.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 border-r-4 border-yellow-400 p-4 rounded">
                  ...
                  <p>
                    المنصة توفر وسيلة لإنشاء والتوقيع على العرائض. نحن لا نضمن:
                  </p>
                  <ul className="list-disc list-inside space-y-1 mr-4 mt-2">
            ...
            <section>
              ...
              <p>
                ...
                أضرار أو خسائر أو نفقات (بما في ذلك أتعاب المحاماة) الناشئة عن:
              </p>
            ...
            <section>
              ...
              <p>
                ...
                فسيتم تعديل هذا الحكم وتفسيره لتحقيق أهداف الحكم الأصلي إلى أقصى
                حد ممكن، وستظل الأحكام المتبقية سارية المفعول.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                تشكل هذه الشروط، جنبًا إلى جنب مع سياسة الخصوصية وأي سياسات أخرى
                منشورة على المنصة، الاتفاقية الكاملة بينك وبيننا فيما يتعلق
                باستخدام المنصة.
              </p>
            </section>
